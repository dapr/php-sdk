...
class UnregisterActorTimerRequest extends \Google\Protobuf\Internal\Message
{
	 ...
	 * @return $this
	 */
	public function setActorType(string $var): UnregisterActorTimerRequest
	{
	 ...
	 * @return $this
	 */
	public function setActorId(string $var): UnregisterActorTimerRequest
	{
		\Google\Protobuf\Internal\GPBUtil::checkString($var, True);
		$this->actor_id = $var;
	 ...
	 * @return $this
	 */
	public function setName(string $var): UnregisterActorTimerRequest
	{
		\Google\Protobuf\Internal\GPBUtil::checkString($var, True);
		$this->name = $var;
